...
import {
	...
	export default {
		...
		methods:{
			...
			editStaffInfo(){
				uni.navigateTo({
					url: '/pages/coupon/setSendCoupons?couponActivityId=' + this.userinfo.couponActivityId + "&staffId=" + this.userinfo.staffId
				})
			},
			gotoList(type){
				let _url = '/pages/coupon/sendCouponsList?couponActivityId=' + this.userinfo.couponActivityId + '&staffId=' + this.userinfo.staffId;
				switch(type){
